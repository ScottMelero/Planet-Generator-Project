...
class Terrain extends Geometry {
  /**
   ...
   */
  constructor(shader, g_points, height, size, image) {
      super(shader);
      this.image = image

      this.vertices = this.generateCubeVertices(g_points, height, size);
  ...
  generateCubeVertices(g_points, height, size){
      var vertices = []
