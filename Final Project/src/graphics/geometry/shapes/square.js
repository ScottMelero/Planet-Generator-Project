...
class Square extends Geometry {
    ...
    generateSquareVertices() {
        ...
        var vertex1 = new Vertex(-32, -2.1, -30)
        var vertex2 = new Vertex(32, -2.1, -30)
        var vertex3 = new Vertex(32, -2.1, 30) 
        var vertex4 = new Vertex(-32, -2.1, -30)
        var vertex5 = new Vertex(-32, -2.1, 30)
        var vertex6 = new Vertex(32, -2.1, 30)
