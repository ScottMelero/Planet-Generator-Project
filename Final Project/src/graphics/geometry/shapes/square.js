...
class Square extends Geometry {
    ...
    generateSquareVertices() {
        ...
        var vertex1 = new Vertex(-50, -2.1, -50)
        var vertex2 = new Vertex(50, -2.1, -50)
        var vertex3 = new Vertex(50, -2.1, 50) 
        var vertex4 = new Vertex(-50, -2.1, -50)
        var vertex5 = new Vertex(-50, -2.1, 50)
        var vertex6 = new Vertex(50, -2.1, 50)
