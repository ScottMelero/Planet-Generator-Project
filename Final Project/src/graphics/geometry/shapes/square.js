...
class Square extends Geometry {
    ...
    generateSquareVertices() {
        ...
        var vertex1 = new Vertex(-100, -10, -100)
        var vertex2 = new Vertex(100, -10, -100)
        var vertex3 = new Vertex(100, -10, 100) 
        var vertex4 = new Vertex(-100, -10, -100)
        var vertex5 = new Vertex(-100, -10, 100)
        var vertex6 = new Vertex(100, -10, 100)
