...
class Square extends Geometry {
    ...
    generateSquareVertices() {
        ...
        var vertex1 = new Vertex(-25, -1, -25, 255, 1, 1)
        var vertex2 = new Vertex(25, -1, -25, 255, 1, 1)
        var vertex3 = new Vertex(25, -1, 25, 255, 1, 1) 
        var vertex4 = new Vertex(-25, -1, -25, 255, 1, 1)
        var vertex5 = new Vertex(-25, -1, 25, 255, 1, 1)
        var vertex6 = new Vertex(25, -1, 25, 255, 1, 1)
